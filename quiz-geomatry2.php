...
<head>
    ...
    { question: "What is the circumference of a circle with radius 7? (Use π ≈ 3.14)", answer: 43.96 },
    { question: "What is the length of the hypotenuse in a right triangle with sides 3 and 4?", answer: 5 },
];
...
<body>
    ...
    <div id="result" class="hidden">
        <h2>Quiz Complete!</h2>
        <p id="final-score"></p>
        <a href="course-math2.php" class="button">Return to Course</a>
    </div>
    <script>
        loadQuestion();
    </script>
